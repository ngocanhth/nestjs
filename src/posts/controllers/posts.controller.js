...
var PostsController = /** @class */ (function () {
    ...
    PostsController.prototype.getPostById = function (_a) {
        var id = _a.id;
        return this.postService.getPostById(Number(id));
    };
    PostsController.prototype.createPost = function (post, req) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                console.log('post: ', post);
                return [2 /*return*/, this.postService.createPost(post, req.user)];
            });
        });
    };
    PostsController.prototype.updatePost = function (_a, post) {
        var id = _a.id;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [2 /*return*/, this.postService.updatePost(Number(id), post)];
            });
        });
    };
    PostsController.prototype.deletePost = function (_a) {
        var id = _a.id;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [2 /*return*/, this.postService.deletePost(Number(id))];
            });
        });
    };
    __decorate([
    ...
    PostsController = __decorate([
        ...
        (0, common_1.UseInterceptors)(new logger_interceptor_1.LoggerInterceptor()),
